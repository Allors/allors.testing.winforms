// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ToolBarTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class ToolBarTest : WinformsTest
    {
        ...
        {
            var tester = new ToolBarTester("toolBar1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<ToolBar>(tester.Target);
        }
