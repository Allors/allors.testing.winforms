// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TrackBarTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class TrackBarTest : WinformsTest
    {
        ...
        {
            var tester = new TrackBarTester("trackBar1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<TrackBar>(tester.Target);
        }
    }
}