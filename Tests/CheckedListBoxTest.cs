// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CheckedListBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class CheckedListBoxTest : WinformsTest
    {
        ...
        {
            var tester = new CheckedListBoxTester("checkedListBox1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<CheckedListBox>(tester.Target);
        }
    }
}