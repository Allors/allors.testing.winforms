// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MaskedTextBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class MaskedTextBoxTest : WinformsTest
    {
        ...
        {
            var tester = new MaskedTextBoxTester("maskedTextBox1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<MaskedTextBox>(tester.Target);
        }
    }
}