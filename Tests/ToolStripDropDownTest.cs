...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class ToolStripDropDownTest : WinformsTest
    {
        ...
        {
            var tester = new ToolStripDropDownTester("toolStripDropDown1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<ToolStripDropDown>(tester.Target);
        }
    }
}