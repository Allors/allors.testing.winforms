// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinkLabelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class LinkLabelTest : WinformsTest
    {
        ...
        {
            var tester = new LinkLabelTester("linkLabel1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<LinkLabel>(tester.Target);
        }
    }
}