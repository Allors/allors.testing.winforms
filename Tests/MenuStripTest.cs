// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MenuStripTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class MenuStripTest : WinformsTest
    {
        ...
        {
            var tester = new MenuStripTester("menuStrip1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<MenuStrip>(tester.Target);
        }
    }
}