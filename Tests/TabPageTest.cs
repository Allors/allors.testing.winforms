// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TabPageTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class TabPageTest : WinformsTest
    {
        ...
        {
            var tester = new TabPageTester("tabPage1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<TabPage>(tester.Target);
        }
    }
}