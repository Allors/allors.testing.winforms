// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TableLayoutPanelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class TableLayoutPanelTest : WinformsTest
    {
        ...
        {
            var tester = new TableLayoutPanelTester("tableLayoutPanel1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<TableLayoutPanel>(tester.Target);
        }
    }
}