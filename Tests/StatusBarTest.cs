// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StatusBarTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class StatusBarTest : WinformsTest
    {
        ...
        {
            var tester = new StatusBarTester("statusBar1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<StatusBar>(tester.Target);
        }
    }
}