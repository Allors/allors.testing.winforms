// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GroupBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class GroupBoxTest : WinformsTest
    {
        ...
        {
            var tester = new GroupBoxTester("groupBox1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<GroupBox>(tester.Target);
        }
    }
}