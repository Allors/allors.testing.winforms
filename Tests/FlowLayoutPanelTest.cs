// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FlowLayoutPanelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class FlowLayoutPanelTest : WinformsTest
    {
        ...
        {
            var tester = new FlowLayoutPanelTester("flowLayoutPanel1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<FlowLayoutPanel>(tester.Target);
        }
    }
}