// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TabControlTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class TabControlTest : WinformsTest
    {
        ...
        {
            var tester = new TabControlTester("tabControl1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<TabControl>(tester.Target);
        }
    }
}