// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MonthCalendarTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class MonthCalendarTest : WinformsTest
    {
        ...
        {
            var tester = new MonthCalendarTester("monthCalendar1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<MonthCalendar>(tester.Target);
        }
    }
}