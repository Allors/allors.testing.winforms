// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SplitterTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class SplitterTest : WinformsTest
    {
        ...
        {
            var tester = new SplitterTester("splitter1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<Splitter>(tester.Target);
        }
    }
}