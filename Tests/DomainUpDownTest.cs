// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainUpDownTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class DomainUpDownTest : WinformsTest
    {
        ...
        {
            var tester = new DomainUpDownTester("domainUpDown1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<DomainUpDown>(tester.Target);
        }
    }
}