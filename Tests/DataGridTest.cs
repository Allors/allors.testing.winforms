// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataGridTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class DataGridTest : WinformsTest
    {
        ...
        {
            var tester = new DataGridTester("dataGrid1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<DataGrid>(tester.Target);
        }
    }
}