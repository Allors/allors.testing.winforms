// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LabelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class LabelTest : WinformsTest
    {
        ...
        {
            var tester = new LabelTester("label1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<Label>(tester.Target);
        }
    }
}