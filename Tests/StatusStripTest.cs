// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StatusStripTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class StatusStripTest : WinformsTest
    {
        ...
        {
            var tester = new StatusStripTester("statusStrip1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<StatusStrip>(tester.Target);
        }
    }
}