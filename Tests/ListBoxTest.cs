// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ListBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class ListBoxTest : WinformsTest
    {
        ...
        {
            var tester = new ListBoxTester("listBox1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<ListBox>(tester.Target);
        }
    }
}