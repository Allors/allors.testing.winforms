// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ToolStripPanelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class ToolStripPanelTest : WinformsTest
    {
        ...
        {
            var tester = new ToolStripPanelTester("toolStripPanel1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<ToolStripPanel>(tester.Target);
        }
    }
}