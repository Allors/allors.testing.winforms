// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RichTextBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    [TestFixture]
    public class RichTextBoxTest : WinformsTest
    {
        ...
        {
            var tester = new RichTextBoxTester("richTextBox1");
            Assert.IsNotNull(tester.Target);
            Assert.IsInstanceOf<RichTextBox>(tester.Target);
        }
    }
}