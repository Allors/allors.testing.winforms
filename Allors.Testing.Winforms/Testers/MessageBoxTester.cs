// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MessageBoxTester.cs" company="allors bvba">
...
namespace Allors.Testing.Winforms.Testers
{
    ...
    {
        public MessageBoxTester(Handle handle) : base(handle)
        {
        }

        public MessageBoxTester(params string[] names) : base(names)
        {
        }
    }
}