// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BindingNavigatorTester.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Testers
{
    ...
    public class BindingNavigatorTester : Tester<BindingNavigator>
    {
        public BindingNavigatorTester(Handle handle) : base(handle)
        {
        }
