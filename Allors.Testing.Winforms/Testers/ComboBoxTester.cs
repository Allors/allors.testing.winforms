// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ComboBoxTester.cs" company="allors bvba">
...
namespace Allors.Immersive.Winforms.Testers
{
    ...
    {
        public ComboBoxTester(Handle handle) : base(handle)
        {
        }

        public ComboBoxTester(params string[] names) : base(names)
        {
        }
